...
private sendStatusToDevice() {
	...
	// added below condition to beep when in entry delay mode
	else if (armMode == 'beep') status = 5
...
// added to handle beep mode on entry delay
def setBeepMode() {setModeHelper("beep",0) }
